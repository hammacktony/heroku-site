...
from app.managers import UrlShortenerManager as UrlShortener
from app.models import PersonalBlog
from app.validators import PostValidator, ScopesValidator
...
class PersonalBlogResource(Resource, JSONSerializer):
    ...
    def create(self, url: UrlShortener, request: Request):  # , upload: Upload):
        """ Create new post """
        ...
        short_link = url.shorten(long_url=self.url.format(slug))
    ...
    def update(self, url: UrlShortener, request: Request):
        " Update Post "
